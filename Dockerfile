...
# 将构建产物jar包拷贝到运行时目录中
COPY --from=build /app/target/eazy-musicEntity-0.0.1.jar .
...
CMD ["java", "-jar", "/app/eazy-musicEntity-0.0.1.jar"]
